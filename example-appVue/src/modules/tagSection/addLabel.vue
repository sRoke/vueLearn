	...
	export default {
	    ...
	    data() {
	      	return {
	      		...
	      		ifsingle : false,
	      		groupName : '',
	      		addlabelApi : '/buyers/tags/group/addBuyersTagsGroupAndTags',
	      		getallLabel : '/buyers/tags/group/getTagGroupAndDetails',
	      		labelList : [{'BUYER_TAG.BUYER_TAG_NAME':''},{'BUYER_TAG.BUYER_TAG_NAME':''},{'BUYER_TAG.BUYER_TAG_NAME':''},{'BUYER_TAG.BUYER_TAG_NAME':''},{'BUYER_TAG.BUYER_TAG_NAME':''}],
	      		configData:{
                    title: '添加标签',
                    titleAlgin: 'left',
                    secondTitle:'',
    	...
    	methods:{
    		addLabel(){
    			var x = {'BUYER_TAG.BUYER_TAG_NAME': ''}
