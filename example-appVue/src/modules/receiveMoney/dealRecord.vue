<template>
	<bu-view :config="configData" @event="eventName">
		<div class="summary-warp">
			...
			<div class="summary-item back-orange">
				...
				<div class="summary-item-money">
					...
					<text class="font-white font46">{{Math.round(allinfos['DEBT_MONEY']*100)/100}}</text>
					<div  style="margin-top:20px">
			...
			<div class="summary-item back-green">
				...
				<div class="summary-item-money">
					...
					<text class="font-white font46">{{Math.round(allinfos['GET_MONEY']*100)/100}}</text>
					<div  style="margin-top:20px">
						<!-- <text class="font-white font24">.00</text>  -->
					</div>
				</div>
		...
		<div class="list-item-title"   v-if="!itemshow">
			...
			<text class="font-gray66 font28 txt-center flex1" :class="[typelist==2?'ischoosed':'notchoosed']" @click="chosetype(2)">欠款</text>
			<text class="font-gray66 font28 txt-center flex1" :class="[typelist==3?'ischoosed':'notchoosed']" @click="chosetype(3)">收款</text>
		</div>
		<!-- 表头 -->
		<!-- 表体 -->
		<div class="list-warp">
			<div class="list-item" v-for="item in list">
					<text class="font-gray33 font32 w-half">{{item['MONEY_DETAIL.OPERATOR_NAME']}}</text>
