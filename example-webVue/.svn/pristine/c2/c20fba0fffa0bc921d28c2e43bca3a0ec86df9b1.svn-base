  ...
  <div v-loading.fullscreen.lock="fullscreenLoading">
    ...
    <div class="m-b-20 ovf-hd">
      <div class="fr w-800 m-l-30">
        <el-row type='flex' justify='end' :gutter='18'>
          <el-col :span='5'>
            <el-select v-model="postData.o_coop_value" placeholder="请选择合作模式" @change="search">
                <el-option
          ...
          <el-col :span='5'>
            <el-select v-model="postData.order_value" placeholder="请选择订单状态" @change="search">
                <el-option
          ...
          <el-col :span='9'>
            <el-input placeholder="输入订单名称、关联客户搜索" v-model="postData.keyword">
...
export default{
  ...
  methods: {
    ...
    getAllUsers() {
      ...
      this.apiGet('orders/service/' + this.serviceid, data).then((res) => {
