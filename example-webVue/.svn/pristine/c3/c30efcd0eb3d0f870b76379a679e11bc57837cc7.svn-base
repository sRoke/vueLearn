    ...
    <el-form :inline="true" :model="servicer_info" label-width="100px">
      <div class='base-info-cont'>
        ...
        { required: true, message: '登录账号不能为空'}]">
              ...
              <el-input v-model="servicer_info.account" placeholder="登录账号" :disabled='!service_edit'></el-input>
            </el-form-item>
          </el-col>
          <el-col :span='8'>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openCategoryDialog(index = null) { // 打开添加和编辑品类对话框
        console.log(index)
      ...
      addCategory(data) { // 向后端请求添加品类和渲染页面
