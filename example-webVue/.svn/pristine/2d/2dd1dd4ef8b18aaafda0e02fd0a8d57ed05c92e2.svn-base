      ...
      <div class="con-text fl">
        ...
        <div class="fl m-l-10 w-620">
          <el-form-item prop="design_type" class="contractMsg">
            <el-radio-group v-model="contract.design_type">
      ...
      <div class="con-text fl">
        ...
        <div class="fl m-l-10 w-620">
          <el-form-item prop="design_output" class="contractMsg">
            <el-checkbox-group v-model="contract.design_output">
        ...
        this.apiGet('orders/' + this.id + '/contracts/' + this.conId).then((res) => {
          ...
          if (res.code == 200) {
            ...
            if (!_.includes(this.conDesignType, res.data.design_type) || res.data.design_type == '其他类型') {
              ...
              this.contract.design_type = '其他类型'
            ...
            for (let i = res.data.design_output.length - 1; i >= 0; i--) {
              if (!_.includes(this.conDesignOutput, res.data.design_output[i]) || res.data.design_output[i] == '其他（副）') {
                ...
                this.contract.design_output[i] = '其他（副）'
