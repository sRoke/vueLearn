...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      openEdit(row) { // 查看需求记录
        router.push({ name: 'demandDetail', params: { id: row.id }})
      },
